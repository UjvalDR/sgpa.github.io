...
{
	$scope.arrlist=[{"userid":1,"name":"CS/IS"},{"userid":2,"name":"EC"},{"userid":3,"name":"CIVIL"},{"userid":4,"name":"MECH"}];
...
$scope.result=function()
{
	...
	var gradeLab2=$scope.calculateGrade($scope.lab3);
...
{
	var cgpa=(($scope.cg12*40)+($scope.cg3*24))/64;
