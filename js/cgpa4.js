...
$scope.resultecs=function()
{
	...
	var sgpa1=((gradeSub11*3)+(gradeSub12*4)+(gradeSub13*3)+(gradeSub14*3)+(gradeSub15*4)+(gradeSub16*4)+(gradeSub17*1)+(gradeLab11*1)+(gradeLab12*1))/24;
...
$scope.cgpa4semdip=function()
{
	var cgpa=(($scope.cgdip3*24)+($scope.cgdip4*24))/48;
	if(isNaN(cgpa))
	{
		return "0";
	}
