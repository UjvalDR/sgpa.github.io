...
$scope.resultcs=function()
{
	...
	var sgpa=((gradeSub1*3)+(gradeSub2*4)+(gradeSub3*3)+(gradeSub4*4)+(gradeSub5*3)+(gradeSub6*3)+(gradeSub7*3)+(gradeLab1*1)+(gradeLab2*1))/25;
...
{
	var cgpa=(($scope.cgdip3*24)+($scope.cgdip4*24)+($scope.cgdip5*25))/73;
	if(isNaN(cgpa))
	{
		return "0";
	}
