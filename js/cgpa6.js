...
$scope.resultcs=function()
{
	...
	var sgpa=((gradeSub1*4)+(gradeSub2*4)+(gradeSub3*3)+(gradeSub4*3)+(gradeSub5*3)+(gradeSub6*2)+(gradeSub7*3)+(gradeLab1*1)+(gradeLab2*1))/24;
...
$scope.resultec=function()
{
	...
	var sgpa1=((gradeSub11*3)+(gradeSub12*4)+(gradeSub13*4)+(gradeSub14*3)+(gradeSub15*3)+(gradeSub16*3)+(gradeSub17*3)+(gradeLab11*1)+(gradeLab12*1))/25;
...
$scope.resultmech=function()
{
	...
	var sgpa2=((gradeSub21*3)+(gradeSub22*3)+(gradeSub23*4)+(gradeSub24*3)+(gradeSub25*4)+(gradeSub26*4)+(gradeSub27*1)+(gradeLab21*1)+(gradeLab22*1))/24;
...
$scope.cgpa5semcs=function()
{
	var cgpa=(($scope.cg1*20)+($scope.cg2*20)+($scope.cg3*24)+($scope.cg4*24)+($scope.cg5*25)+($scope.cg6*24))/137;
	if(isNaN(cgpa))
	{
		return "0";
	}
...
$scope.cgpa5semec=function()
{
	var cgpa=(($scope.cg1*20)+($scope.cg2*20)+($scope.cg3*24)+($scope.cg4*24)+($scope.cg5*25))/113;
	if(isNaN(cgpa))
	{
		return "0";
	}
...
$scope.cgpa5semmech=function()
{
	var cgpa=(($scope.cg12*40)+($scope.cg3*24)+($scope.cg4*24))/88;
	if(isNaN(cgpa))
	{
		return "0";
	}
...
$scope.cgpa5semdip=function()
{
	var cgpa=(($scope.cgdip3*24)+($scope.cgdip4*24)+($scope.cgdip5*25)+($scope.cgdip6*24))/97;
	if(isNaN(cgpa))
	{
		return "0";
	}
